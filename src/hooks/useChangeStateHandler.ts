...
export type ChangeStateHandler<S extends object, P extends ObjectKey = 'value'> = <K extends keyof S, T extends S[K]>(key: K) => (value: (TypedChangeEvent<T, P> | T)) => void;

const useChangeStateHandler = <S extends object, P extends ObjectKey = 'value'>(
    setState: Dispatch<SetStateAction<S>>,
    property: P = 'value' as P
): ChangeStateHandler<S, P> => {
